...
/** To perform queries and updates on multiple threads, you'll want to use `FMDatabaseQueue`.
 ...
 @warning We are not provide nested calling support. If you perform operation/transaction inside other operation/transaction, we check for blocking deadlock but the behavior is undefined.
